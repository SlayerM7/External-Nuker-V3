        ...
        if (typeof res !== "undefined")
            if (typeof res.body !== "undefined") {
                if (res.body.message === "Missing Permissions") {
                    console.log(createString_1.createString(`Failed to create channel`, "semi", "fail"));
                }
                    ...
                    console.log(createString_1.createString(`Created channel`, "semi"));
                }
            }
    }));
}
function default_1(client, guildId, params = { amount: 10, name: "no-name-given" }, rl, server) {
